...
// 
namespace TersoSolutions.Jetstream.SDK.Application.Messages.CommandQueuedEvent
{
    using System.Xml.Serialization;
    
    /// <summary>
    /// CommandQueuedEvent is published when a command has been issued
    /// to a device. The CommandQueuedEvent will include any output parameters, 
    /// exceptions and device extensions for completing the command. The command
    /// ID is a cross reference between the CommandQueuedEvent and the CommandCompletionEvent
    /// once the device processes the request.
    /// </summary>
