...
namespace TersoSolutions.Jetstream.SDK.Application.Model
{
    ...
    /// 
    /// Response object for the Jetstream GetPolicies.
    /// </summary>
    /// <remarks></remarks>
    public class GetPoliciesResponse : JetstreamResponse
    {
        private GP.Jetstream _deserializedResponse;
        ...
        public List<GP.JetstreamGetPoliciesResponsePolicy> PolicyList
        {
            get
            {
                ...
                {
                    _deserializedResponse = _deserializedResponse ?? GP.Jetstream.Deserialize(Body);
