...
namespace TersoSolutions.Jetstream.SDK.Application.Model
{
    ...
    ///
    /// Request object for the Jetstream RemoveDeviceFromPolicy endpoint.
    /// </summary>
    /// <remarks></remarks>
    public class RemoveDeviceFromPolicyRequest : JetstreamRequest
    {
        private const string _removeDeviceFromPolicy = "v1.5/application/?action=removedevicefrompolicy&accesskey={0}&logicaldeviceid={1}";
        ...
        internal override string BuildUri(string baseUri, string accesskey)
        {
            return String.Concat(baseUri, String.Format(
                _removeDeviceFromPolicy,accesskey, LogicalDeviceId));
        }
    }
}
