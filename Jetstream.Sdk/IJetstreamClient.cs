...
namespace TersoSolutions.Jetstream.Sdk
{
    ...
    public interface IJetstreamClient : IDisposable
    {
        ...
        /// <returns></returns>
        List<string> AddDeviceCredentials(string deviceName, DeviceCredentialTypes type, List<string> credentials);
        ...
        /// <param name="credentials"></param>
        /// <returns></returns>
        List<string> AddDeviceCredentials(string deviceName, DeviceCredentialTypes type, Dictionary<string, string> credentials);
        ...
        /// <param name="credentials"></param>
        /// <returns></returns>
        List<string> ModifyDeviceCredentials(string deviceName, DeviceCredentialTypes type, List<string> credentials);
        ...
        /// <param name="credentials"></param>
        /// <returns></returns>
        List<string> ModifyDeviceCredentials(string deviceName, DeviceCredentialTypes type, Dictionary<string, string> credentials);
        ...
        /// <param name="type"></param>
        /// <returns></returns>
        List<string> GetDeviceCredentials(string deviceName, DeviceCredentialTypes type);
        ...
        /// <param name="credentials"></param>
        /// <returns></returns>
        List<string> DeleteDeviceCredentials(string deviceName, DeviceCredentialTypes type, List<string> credentials);
